...
class Manga4koma_Experiment():
    def __init__(self, touch_name, p_label, batch_size=16, epochs=200, bairitsu=1):
        ...
        self.log_path = './result_' + self.touch_name + '_' + P_DIC[self.p_label] + '_hotto_epoch50_fine_ex3.txt'
        self.new_model_path = '../models/bert/My_Japanese_transformers/' + self.touch_name + '_' + P_DIC[self.p_label] + '_hotto_epoch50_fine_ex3.bin'
    ...
    def set_dataset(self, k_phase=0):
        self.train_loader, self.valid_loader, self.test_loader, self.test_data_set, self.w = \
            get_data_loader(self.touch_name, self.batch_size, self.p_label, k_phase)
