...
class Manga4koma_Experiment():
    def __init__(self, touch_name, p_label, batch_size=16, epochs=200, bairitsu=1):
        ...
        self.log_path = './result_' + self.touch_name + '_' + P_DIC[self.p_label] + '_seq_len4_last_0713_epoch50.txt'
        self.new_model_path = '../models/bert/My_Japanese_transformers/' + self.touch_name + '_' + P_DIC[self.p_label] + '_seq_len4_last_0713_epoch50.bin'
