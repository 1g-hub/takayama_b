...
class Manga4koma_Experiment():
    def __init__(self, touch_name, p_label, batch_size=16, epochs=200):
        ...
        self.log_path = './result_' + self.touch_name + '_' + P_DIC[self.p_label] + '_multi_bert_last_layer.txt'
        self.new_model_path = '../models/bert/My_Japanese_transformers/' + self.touch_name + '_' + P_DIC[self.p_label] + '_multi_bert_last_layer.bin'
    ...
    def optuna_optimize(self):
        ...
        study.optimize(self.objective_variable(), n_trials=3)
